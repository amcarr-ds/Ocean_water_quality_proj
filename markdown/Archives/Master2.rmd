...
Connie Chow - HoltWinters Modeling for all Parameters and all tables
...
```{r MODELING-CC-FORECAST-USING-ETS}

train_window <- window(ts_owt_df02_gb09_sboo_wkly02_train_tb03, start=c(2013, 1), end=c(2021, 1))
