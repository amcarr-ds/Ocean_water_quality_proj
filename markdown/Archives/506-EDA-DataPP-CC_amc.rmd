...
ts_eda <- function(ts_df = NA,
  ...
  for(p in param_lst) {
    ...
    # If keyword set to TRUE, removed outliers
    if(out_rm == TRUE) {
...
ts_1996_2001_chl <- window(ts_chlorophyll, start=c(1999, 1), end=c(2009, 1))
...
```{r}
#print(head(owt_df02_gb04_mrgd, 17))
#print(head(owt_df02_gb09_mrgd, 17))
#print(head(owt_df02_gb07_mrgd, 17))
...
print(head(owt_df02_gb04_tbbl, 17))
print(head(owt_df02_gb04_wkly_tbbl, 17))
print(head(owt_df02_gb09_tbbl, 17))
print(head(owt_df02_gb09_wkly_tbbl, 17))
print(head(owt_df02_gb07_tbbl, 17))
print(head(owt_df02_gb07_wkly_tbbl, 17))
```
...
```{r, fig.height=15, fig.width=30}
time_plt(df = owt_df02_gb09_mrgd,
         date = "date_sample",
         l1 = param_lst05,
         l2_name = "project",
         l2 = uniq_proj)
