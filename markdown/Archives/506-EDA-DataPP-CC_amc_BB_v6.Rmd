...
```{r, message=FALSE, warning=FALSE, error=FALSE, fig.height=10, fig.width=30}
...
```{r EDA-CC-linearinterpolation, warning=FALSE, error=FALSE}
...
```{r CC-EDA-PAD-MISSINGDATES, message=FALSE, warning=FALSE, error=FALSE}
...
m1v1_lin_out <- lr_ts_mod(tb_train = owt_df02_gb09_ploo_wkly03_train_tb03,
                          ...
                          freq = 52,
                          h = 52,
                          formula = "ENTERO ~ trend + season + CHLOROPHYLL + DENSITY + DO + FECAL + PH + SALINITY + TEMP + XMS")
