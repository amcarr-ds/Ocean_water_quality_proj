...
owt_df02_gb09_ploo_wkly03_df01 <- owt_df02_gb09_wkly03[owt_df02_gb09_wkly03$project == "PLOO" & owt_df02_gb09_wkly03$date_sample >= train_start, ]
...
owt_df02_gb09_ploo_wkly02_df01 <- owt_df02_gb09_wkly02[owt_df02_gb09_wkly02$project == "PLOO" & owt_df02_gb09_wkly02$date_sample >= train_start, ]
...
owt_df02_gb09_sboo_wkly03_df01 <- owt_df02_gb09_wkly03[owt_df02_gb09_wkly03$project == "SBOO" & owt_df02_gb09_wkly03$date_sample >= train_start, ]
...
owt_df02_gb09_sboo_wkly02_df01 <- owt_df02_gb09_wkly02[owt_df02_gb09_wkly02$project == "SBOO" & owt_df02_gb09_wkly02$date_sample >= train_start, ]
...
lr_ts_mod <- function(tb_train = NA,
                      ...
                      h = NA,
                      formula = NA) {
  train_ts01 <- ts(tb_train[, param],
                   start = train_start,
                   freq = freq)
  #print(train_ts01)
  
  test_ts01 <- ts(tb_test[, param],
                  start = test_start,
                  freq = freq)
  #print(test_ts01)

  lin_mod_fit <- tslm(formula = as.formula(formula))
  lin_mod_prd <- forecast(lin_mod_fit, h = h)
  
  tb_train_s1 <- subset(x = tb_train, select = c(date, param))
  tb_test_s1 <- subset(x = tb_test, select = c(date, param))
  
  print(lin_mod_prd)
  print(test_ts01)
  print(accuracy(lin_mod_prd, test_ts01))
  
  return(list(train_ts01, test_ts01, lin_mod_prd))
}
...
owt_df02_gb09_ploo_wkly03_train_tb02 %>%
...
m1v1_lin_out <- lr_ts_mod(tb_train = owt_df02_gb09_ploo_wkly03_train_tb02,
                          tb_test = owt_df02_gb09_ploo_wkly03_test_tb02,
                          date = "date_sample",
                          param = "ENTERO",
                          train_start = c(1999, lubridate::isoweek(ymd(train_start))),
                          test_start = c(2021, lubridate::isoweek(ymd(test_start))),
                          freq = 52,
                          h = 104,
                          formula = "train_ts01 ~ trend + I(trend^2) + season")


#print(m1v1_lin_out[[3]])

# Citation: USD. (n.d.). ADS 506 Lab 3.2.R [Module 3 course materials].
