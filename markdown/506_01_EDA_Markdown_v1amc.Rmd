...
#box_comp(xcol = x01_lst02, df = subset(x = train_x01_df03, select = x01_lst02), rtn_met = TRUE)

#train_x02_df03 <- subset(x = train_x02_df01, select = x02_lst02)
#train_x02_df03 <- na.omit(train_x02_df03)
#print(head(train_x02_df03))
#box_comp(xcol = x02_lst02, df = subset(x = train_x02_df03, select = x02_lst02), rtn_met = TRUE)
